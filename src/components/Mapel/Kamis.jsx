	...
	return (
		<>
			<div
				...
				<div className="flex justify-center items-center text-sm">08.30-09.50</div>
			</div>
			<div
				...
				<div className="flex justify-center items-center text-sm">09.50-10.05</div>
			</div>
			<div
				className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3"
				data-aos="fade-up"
				...
				<div className="flex justify-center items-center text-sm">10.05-11.25</div>
			</div>
			<div
				className=" border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3"
				data-aos="fade-up"
				data-aos-duration="800">
				<div className="w-[50%] text-base  font-medium">Tahsin Tahfidz</div>
				<div className="flex justify-center items-center text-sm">11.25-13.30</div>
			</div>
			...
			<div
				...
				<div className="w-[50%] text-base font-medium">Ihsoma</div>
				<div className="flex justify-center items-center text-sm">12.05-12.50</div>
			</div>
			<div
				className="border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3"
				data-aos="fade-up"
