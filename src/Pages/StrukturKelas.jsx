	...
	return (
		<div className="z-1  relative h-auto lg:h-[83vh] lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="J.Nafa Nabila Salsabila, S.Pd" Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Kebersihan" Nama="Hafiz AB" Width="120px" />
					</div>
				{/* Kesehatan */}
					<div className="flex-col hidden lg:flex">
						<BorderStruktur Jabatan="Kesehatan" Nama="Qiesthie	" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Saddam" Width="120px" />
					</div>
				</div>
